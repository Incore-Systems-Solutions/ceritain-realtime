    ...
    >
      ...
      >
        ...
        <div className="flex gap-2">
          ...
          >
            <span className="text-gray-900 font-semibold text-sm">Batal</span>
          </motion.button>
          ...
          >
            ...
            <span className="text-white font-semibold text-sm">Mulai Call</span>
          </motion.button>
        </div>
      </motion.div>
    </motion.div>
